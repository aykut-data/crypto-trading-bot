...
def fetch_1d_data(symbol="BTCUSDT", days=365):
    """
    Fetch 1-day kline data for the specified symbol from Binance.
    ...
    print(f"📡 Fetching 1d {symbol} data for the last {days} days...")
...
def save_to_csv(klines, full_path):
    ...
    # Select only OHLCV and Timestamp
...
if __name__ == "__main__":
    ...
    target_file = os.path.join(data_dir, "btc_usdt_1d.csv")
    
    # Fetch 1 year of daily data
    raw_data = fetch_1d_data("BTCUSDT", days=365)
    
    # Save to the dynamic data directory
