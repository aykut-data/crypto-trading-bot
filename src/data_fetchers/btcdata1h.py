...
def fetch_1h_data(symbol="BTCUSDT", days=180):
    """
    Fetch 1-hour kline data for the specified symbol from Binance.
    """
    ...
    print(f"📡 Fetching 1h {symbol} data for the last {days} days...")
...
if __name__ == "__main__":
    ...
    target_file = os.path.join(data_dir, "btc_usdt_1h.csv")
    
    # Fetch 180 days of 1-hour data
    raw_data = fetch_1h_data("BTCUSDT", days=180)
