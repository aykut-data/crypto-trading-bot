...
if __name__ == "__main__":
    ...
    input_file = os.path.join(data_dir, "btc_usdt_4h.csv")
    output_file = os.path.join(data_dir, "btc_usdt_4h_indicators.csv")
    
    if os.path.exists(input_file):
        print(f"📊 Loading raw 4h data from: {input_file}")
