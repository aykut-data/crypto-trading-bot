...
if __name__ == "__main__":
    ...
    input_file = os.path.join(data_dir, "btc_usdt_1h.csv")
    output_file = os.path.join(data_dir, "btc_usdt_1h_indicators.csv")
    
    if os.path.exists(input_file):
        print(f"📊 Loading raw 1h data from: {input_file}")
