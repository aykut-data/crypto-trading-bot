...
if __name__ == "__main__":
    ...
    input_file = os.path.join(data_dir, "btc_usdt_1d.csv")
    output_file = os.path.join(data_dir, "btc_usdt_1d_indicators.csv")
    
    if os.path.exists(input_file):
        print(f"📊 Loading raw 1d data from: {input_file}")
